...
public class TracksDatabase extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME_REFERENCE_TABLES = "table_names";    // This table contains all other table names that make references to "all_tracks".
    private static final String TABLE_NAME_LOCAL_MUSIC = "tracks_local";        // This is one of the tables that only contain references to track ids of the "all_tracks" table.
    ...
    private static final String SQL_CREATE_REFERENCE_TABLE = "CREATE TABLE IF NOT EXISTS %s(id INTEGER PRIMARY KEY AUTOINCREMENT, db_id INTEGER, FOREIGN KEY(db_id) REFERENCES all_tracks(id));";
    ...
    public static String getTableNameLocalLibraries() {return TABLE_NAME_LOCAL_LIBRARIES;}
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(String.format(SQL_CREATE_REFERENCE_TABLE, TABLE_NAME_LOCAL_MUSIC));
        sqLiteDatabase.execSQL(SQL_CREATE_TABLE_NAMES_TABLE);

        ContentValues contentValues = new ContentValues();
        contentValues.put("table_name", TABLE_NAME_LOCAL_MUSIC);
        sqLiteDatabase.insert(TABLE_NAME_REFERENCE_TABLES, null, contentValues);
    }
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        String sqlDropTableNames = String.format("DROP TABLE IF EXISTS %s;", TABLE_NAME_REFERENCE_TABLES);
    ...
    private ArrayList<String> getTableNames() {
        ...
        Cursor cursor = db.query(TABLE_NAME_REFERENCE_TABLES, columns, null, null, null, null, null, null);
    ...
    public TrackTable newTable(String tableName) {
        ...
        if (!tableNames.contains(tableName)) {
            ...
            String sqlCreatePlaylist = String.format(SQL_CREATE_REFERENCE_TABLE, tableName);
            db.execSQL(sqlCreatePlaylist);

            ContentValues contentValues = new ContentValues();
            contentValues.put("table_name", tableName);
            db.insert(TABLE_NAME_REFERENCE_TABLES, null, contentValues);
            db.close();
        }
